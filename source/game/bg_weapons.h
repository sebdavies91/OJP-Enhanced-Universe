...
#define HI_ALLDISABLED		177776
#define HI_GRAPPLEHOOKJETPACKS		177777
#define HI_GRAPPLEHOOKJETPACKSVEHICLES		266664
#define HI_NOVEHICLES			266665			

#define FP_NEUTRALSONLY		16353
#define FP_JUMPONLY		262141
