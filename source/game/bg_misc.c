...
//[/ExpSys]
{
	...
	*/
	...
	{	0,	1, 1,	 1	 },//SK_DISRUPTORB,
	{	0,	1, 1,	 1	 },//SK_BOWCASTERA,
	{	0,	1, 1,	 1	 },//SK_BOWCASTERB,
	{	0,	1, 1,	 1	 },//SK_REPEATERA,
	{	0,	1, 1,	 1	 },//SK_REPEATERB,
	{	0,	1, 1,	 1	 },//SK_DEMP2A,
	{	0,	1, 1,	 1	 },//SK_DEMP2B,
	{	0,	1, 1,	 1	 },//SK_FLECHETTEA,
	{	0,	1, 1,	 1	 },//SK_FLECHETTEB,
	{	0,	1, 1,	 1	 },//SK_CONCUSSIONA,
	{	0,	1, 1,	 1	 },//SK_CONCUSSIONB,
	{	0,	1, 1,	 1	 },//SK_ROCKETA,
	{	0,	1, 1,	 1	 },//SK_ROCKETB,
	{	0,	1, 1,	 1	 },//SK_THERMALA,
	{	0,	1, 1,	 1	 },//SK_THERMALB,
	{	0,	1, 1,	 1	 },//SK_TRIPMINEA,
	{	0,	1, 1,	 1	 },//SK_TRIPMINEB,
	{	0,	1, 1,	 1	 },//SK_DETPACKA,
	{	0,	1, 1,	 1	 },//SK_DETPACKBB,
	{	0,	1, 1,	 1	 },//SK_OLDA,
	{	0,	1, 1,	 1	 },//SK_OLDB,
	...
	{	0,	1, 1,	 0	 },//SK_PUSHA,
	{	0,	1, 1,	 0	 },//SK_PULLA,	
	{	0,	10,	10,	10	},	//SK_POWER,		//shield skill
	{	0,	10,	10,	10	},	//SK_RESISTANCE	//shieldbooster skill
};
...
int WeaponReadyAnim9[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponReadyLegsAnim9[WP_NUM_WEAPONS] =
{
	BOTH_STAND1,//WP_NONE,
...
int WeaponAttackAnim9[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim10[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponAttackAnim10[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim11[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponReadyLegsAnim11[WP_NUM_WEAPONS] =
{
	BOTH_STAND1,//WP_NONE,
...
int WeaponAttackAnim11[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
...
int WeaponReadyAnim12[WP_NUM_WEAPONS] =
{
	TORSO_DROPWEAP1,//WP_NONE,
...
int WeaponAttackAnim12[WP_NUM_WEAPONS] =
{
	BOTH_ATTACK1,//WP_NONE, //(shouldn't happen)
